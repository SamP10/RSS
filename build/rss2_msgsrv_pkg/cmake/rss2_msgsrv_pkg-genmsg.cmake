...
get_filename_component(_filename "/home/sam/catkin_ws/src/rss2_msgsrv_pkg/msg/date_cmd_vel.msg" NAME_WE)
add_custom_target(_rss2_msgsrv_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rss2_msgsrv_pkg" "/home/sam/catkin_ws/src/rss2_msgsrv_pkg/msg/date_cmd_vel.msg" "geometry_msgs/Twist:geometry_msgs/Vector3"
)

get_filename_component(_filename "/home/sam/catkin_ws/src/rss2_msgsrv_pkg/srv/srv_turtlebot_move.srv" NAME_WE)
add_custom_target(_rss2_msgsrv_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rss2_msgsrv_pkg" "/home/sam/catkin_ws/src/rss2_msgsrv_pkg/srv/srv_turtlebot_move.srv" ""
)

get_filename_component(_filename "/home/sam/catkin_ws/src/rss2_msgsrv_pkg/srv/turtlebot_move_square.srv" NAME_WE)
add_custom_target(_rss2_msgsrv_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rss2_msgsrv_pkg" "/home/sam/catkin_ws/src/rss2_msgsrv_pkg/srv/turtlebot_move_square.srv" ""
)
...
_generate_msg_cpp(rss2_msgsrv_pkg
  "/home/sam/catkin_ws/src/rss2_msgsrv_pkg/msg/date_cmd_vel.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rss2_msgsrv_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rss2_msgsrv_pkg\")")
  # install generated code
  install(
